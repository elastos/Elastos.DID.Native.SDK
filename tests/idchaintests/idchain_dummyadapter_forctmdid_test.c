...
static void test_publish_ctmdid_withonecontroller(void)
{
    ...
    CU_ASSERT_NOT_EQUAL(rc, -1);
    CU_ASSERT_TRUE_FATAL(DIDStore_PublishDID(store, storepass, &customizedid, keyid, false));
...
static void test_publish_ctmdid_with_multicontroller(void)
{
    ...
    CU_ASSERT_PTR_NULL_FATAL(customized_doc);
    ...
    DIDDocumentBuilder_Destroy(builder);
    CU_ASSERT_STRING_EQUAL("The controller already signed the DID.", DIDError_GetMessage());
    ...
    CU_ASSERT_TRUE_FATAL(DIDStore_PublishDID(store, storepass, &customizedid, signkey1, true));
    ...
    data1 = DIDDocument_ToJson(customized_doc, true);
    DIDDocument_Destroy(customized_doc);
    CU_ASSERT_PTR_NOT_NULL(data1);
    data2 = DIDDocument_ToJson(resolve_doc, true);
    DIDDocument_Destroy(resolve_doc);
    ...
    customized_doc = DIDDocument_SignDIDDocument(controller2_doc, data1, storepass);
    free((void*)data1);
    CU_ASSERT_PTR_NOT_NULL(customized_doc);
    CU_ASSERT_NOT_EQUAL(-1, DIDStore_StoreDID(store, customized_doc));
