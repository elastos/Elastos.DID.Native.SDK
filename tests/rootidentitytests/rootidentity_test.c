...
static const char *expectedIDString = "iY4Ghz9tCuWvB5rNwvn4ngWvthZMNzEA7U";
...
static void test_rootidentity_newdid(void)
{
    ...
    CU_ASSERT_PTR_NOT_NULL(RootIdentity_GetAlias(_rootidentity));
    ...
    //set did2 to default
    CU_ASSERT_NOT_EQUALS(-1, RootIdentity_SetDefaultDID(_rootidentity, did));
    DID_Destroy(did);
